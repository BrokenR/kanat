...
Процедура КАНАТ_ЗаполнитьДоступныеПоля()
	...
	ИначеЕсли Объект.Назначение = Перечисления.НазначенияШаблоновЭтикетокИЦенников.ЭтикеткаСерииНоменклатуры Тогда
		...
		#Вставка
		ИменаПолей.Добавить("Серия.КАНАТ_Номенклатура.Артикул");
		ИменаПолей.Добавить("Серия.КАНАТ_Номенклатура.Код");
		ИменаПолей.Добавить("Серия.КАНАТ_Характеристика");
		ИменаПолей.Добавить("Серия.КАНАТ_ВесЕдиницаИзмерения");
		ИменаПолей.Добавить("Серия.КАНАТ_Вес");
		#КонецВставки
